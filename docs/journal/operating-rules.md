...
- Even temporary changes for demos or debugging (e.g. auth bypass) get a separate restore-before-commit policy note ([memory: project_demo_temp_changes](https://github.com/je0ng3/vibi/blob/main/README.md) and similar transient notes).
