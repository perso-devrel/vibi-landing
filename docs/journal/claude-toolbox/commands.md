...
[`.claude/commands/plan.md`](https://github.com/je0ng3/vibi/blob/main/.claude/commands/plan.md)
...
[`.claude/commands/sync-api.md`](https://github.com/je0ng3/vibi/blob/main/.claude/commands/sync-api.md)
...
[`.claude/commands/review.md`](https://github.com/je0ng3/vibi/blob/main/.claude/commands/review.md)
...
[`.claude/commands/ship.md`](https://github.com/je0ng3/vibi/blob/main/.claude/commands/ship.md)
...
- [Workspace `CLAUDE.md`](https://github.com/je0ng3/vibi/blob/main/CLAUDE.md) § "Root slash commands" — the one-line catalog of the same four commands
