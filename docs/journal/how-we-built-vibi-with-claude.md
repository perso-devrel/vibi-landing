...
1. **We ship iOS too** — the mobile video + speech + stem separation category is mobile-first ([`../../PITCH.md`](https://github.com/je0ng3/vibi/blob/main/PITCH.md)), and skipping iOS isn't an option.
