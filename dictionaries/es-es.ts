...
export const esES: Dict = {
  meta: {
    title: "VIBI — Conserva el vídeo. Borra solo el ruido.",
    description:
  ...
  announcement: {
    badge: "Beta",
    message: "Los pagos aún no están activos — puedes probar VIBI gratis ahora mismo.",
    feedbackText: "Envíanos una reseña o tu opinión y te sumamos 5 créditos de regalo.",
  ...
  hero: {
    ...
    titleLines: ["Conserva el vídeo.", "Borra solo el ruido."],
    ...
    ctaAndroid: "Avísame al lanzar Android",
  ...
  apps: {
    ...
    body: "La misma separación, la misma cuenta, los mismos créditos. Empieza en tu móvil donde grabas y termina en Premiere donde editas — tus créditos te acompañan en ambos.",
    items: [
      {
        kind: "ios",
        ...
        body: "Elige un clip y toda la pista se separa. Divídelo en regiones y silencia, atenúa o ralentiza solo la parte que te molesta — listo en menos de cinco minutos.",
        points: ["Separación de pistas de todo el clip", "Silencia / atenúa / ralentiza por región", "Añade BGM o edita por chat"],
        ctaLabel: "Descárgalo en iOS",
        ctaLabelAndroid: "Avísame al lanzar Android",
      },
      {
        kind: "premiere",
  ...
  why: {
    ...
    rows: [
      ...
      { label: "Si el audio se estropea", legacy: "Vuelve a grabar o descarta el clip", vibi: "Conserva la toma, borra solo el audio" },
      { label: "Dónde trabajas", legacy: "Atado a un solo flujo", vibi: "iPhone sobre el terreno · Premiere Pro en el escritorio" },
    ],
  },
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Divide el clip separado en regiones y silencia, atenúa o ralentiza solo la parte que te molesta. Añade BGM o graba desde el micrófono, luego exporta y comparte — listo en menos de cinco minutos.",
      },
      {
  ...
  scenario: {
    ...
    body: "El momento era demasiado bueno para repetirlo, pero un transeúnte arruinó el audio. Con VIBI, recuperarlo lleva menos de cinco minutos.",
    beforeTitle: "Antes — a la vieja usanza",
    afterTitle: "Después — VIBI",
    before: [
      "Volver al escritorio, abrir el portátil",
      "Pasar el clip al ordenador (5–15 min)",
      "Buscar “cómo quitar una voz de un vídeo”",
      "Probar app tras app, tutorial tras tutorial — sigues atascado",
      "Rendirte; volver a grabar o descartar el clip",
    ],
    after: [
      "Elige el clip de tu carrete",
      ...
      "Suelta una BGM si hace falta → exporta → comparte",
    ],
  },

  workflow: {
    eyebrow: "Flujo de trabajo",
    title: "Lo que antes exigía un estudio, ahora en dos apps.",
    body: "Ya sea en tu móvil sobre el terreno o metido en Premiere en el escritorio — el momento no se te escapa.",
    pcLabel: "A la vieja usanza",
    vibiLabel: "VIBI",
    rows: [
      { step: "Importar el clip", pc: "Cable / iCloud / AirDrop · 5–15 min", vibi: "Desde tu galería en iPhone, o el panel Proyecto en Premiere" },
      { step: "Borrar un ruido", pc: "EQ + multibanda + cortes manuales — y la voz suele morir con ello", vibi: "Separa y luego silencia la pista o región que no quieres" },
      { step: "Vista previa", pc: "Renderizar y luego reproducir", vibi: "Reproduce al instante — en la línea de tiempo o en el panel" },
      { step: "Publicar", pc: "Exportar → enviar → subir", vibi: "Menú de compartir en el móvil, o un .wav limpio de vuelta a tu secuencia" },
    ],
  },
  ...
  cta: {
    ...
    body: "Empieza en tu móvil donde grabas y termina en Premiere donde editas — tu cuenta y tus créditos te acompañan en ambos.",
    primary: "Descárgalo en iOS",
    android: "Avísame al lanzar Android",
    secondary: "Instala el panel de Premiere Pro",
    caption: "iOS y Android en revisión · Premiere Pro 26+ · créditos compartidos entre ambos",
  },

  jsonLd: {
    featureList: [
      "Separa voz, instrumental y sonido de fondo de cualquier vídeo con un toque",
      "Activa y ajusta el volumen de cada pista separada",
      "Añade música de fondo en un rango personalizado",
      "Edita secciones específicas de la línea de tiempo del vídeo",
      "Previsualiza los cambios antes de exportar el vídeo",
    ],
  },

  footer: {
    tagline: "Conserva el vídeo. Borra solo el ruido — en iPhone y en Premiere Pro.",
